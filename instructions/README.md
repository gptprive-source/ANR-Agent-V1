# Instructions pour l’agent ANR V1

1. Tu ne touches jamais au repo ANR.
2. Tu lis ANR uniquement pour récupérer infos utiles.
3. Tu crées un module séparé pour la V1 Visio.
